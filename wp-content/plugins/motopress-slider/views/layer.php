...
<!--			    </div>-->
			    ...
			    <div class="mpsl-option-wrapper">
			        <div class="mpsl-duration-info">
			            <?php echo __('Slide duration (ms):', 'motopress-slider') . ' ' . $this->slider->options['slideshow']['options']['slider_delay']['value']; ?>
			        </div>
			    </div>
		    </div>
		    <div class="col-9-12">
		    ...
		    <div class="col-5-12">
			    ...
			    <div class="mpsl-option-wrapper mpsl-option-offset-top">
		            <div class="mpsl-layout-style-header">
		                <i><?php _e('* Custom layer options for this particular screen size', 'motopress-slider'); ?></i>
		            </div>
		        </div>
