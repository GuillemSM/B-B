...
<div id="mpsl-import-export-wrapper">
    <div class="mpsl-import-wrapper">
        ...
        <form id="mpsl-import-form" action="<?php echo admin_url( 'admin.php?import=mpsl-importer&step=2'); ?>" method="post" enctype="multipart/form-data" >
            <p><?php printf(__( 'To import sliders select previously exported %s file and click the Import button.', 'motopress-slider' ), $mpsl_settings['product_name']); ?></p>
            ...
            <label for="mpsl_http_auth"><?php _e('Enable HTTP authentication', 'motopress-slider');?></label>
            <br/>
        ...
        <div class="mpsl-export-wrapper">
            ...
            <form id="mpsl-export-form" action="<?php echo $this->getSlidersExportUrl(); ?>" method="post">            
                ...
                <fieldset>
                        ...
                        <p><?php  _e( 'Export and download selected sliders. You can import them later on your new website.', 'motopress-slider' ); ?></p>
