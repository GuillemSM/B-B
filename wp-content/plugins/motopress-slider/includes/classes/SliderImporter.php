...
class MPSLSliderImporter {      
    ...
    public function renderImportPage(){  
        global $mpsl_settings;
        echo '<h1>' . sprintf(__('Import %s', 'motopress-slider'), $mpsl_settings['product_name']) . '</h1>';
    ...
    ?>                
        <form action="<?php echo admin_url( 'admin.php?import=mpsl-importer&step=2'); ?>" method="post" enctype="multipart/form-data" >
            <p><?php printf(__('To import sliders select previously exported %s file and click the Import button.', 'motopress-slider'), $this->mpsl_settings['product_name']); ?></p>
