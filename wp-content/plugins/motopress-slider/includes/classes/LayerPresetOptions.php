		...
		if (is_null(self::$fontList)) {
			...
			if (!is_null($googleFonts) && isset($googleFonts['items'])) {
				foreach ($googleFonts['items'] as $gFont) {
					...
					array_unshift($gFont['variants'], array('value' => '', 'label' => __('Inherit', 'motopress-slider')));
	...
	public static function getDefaultFontWeightList() {
		if (is_null(self::$defaultFontWeightList)) {
			self::$defaultFontWeightList = array(
				array('value' => '',    'label' => __('Inherit', 'motopress-slider')),
				array('value' => '100', 'label' => __('100 (Thin)', 'motopress-slider')),
				array('value' => '200', 'label' => __('200 (Extra Light)', 'motopress-slider')),
				array('value' => '300', 'label' => __('300 (Light)', 'motopress-slider')),
				array('value' => '400', 'label' => __('400 (Normal)', 'motopress-slider')),
				array('value' => '500', 'label' => __('500 (Medium)', 'motopress-slider')),
				array('value' => '600', 'label' => __('600 (Semi Bold)', 'motopress-slider')),
				array('value' => '700', 'label' => __('700 (Bold)', 'motopress-slider')),
				array('value' => '800', 'label' => __('800 (Extra Bold)', 'motopress-slider')),
				array('value' => '900', 'label' => __('900 (Heavy)', 'motopress-slider')),
			);
		}
